...
# === Load model ===
model = joblib.load(r"C:\Users\tinku\OneDrive\Desktop\GitHub_Files\EV_Vehicle_Charge_Demand_Prediction\forecasting_ev_model.pkl")
...
# Image
st.image(r"C:\Users\tinku\OneDrive\Desktop\GitHub_Files\EV_Vehicle_Charge_Demand_Prediction\ev-car-factory.jpg", use_container_width=True)
...
@st.cache_data
def load_data():
    df = pd.read_csv(r"C:\Users\tinku\OneDrive\Desktop\GitHub_Files\EV_Vehicle_Charge_Demand_Prediction\preprocessed_ev_data.csv")
